...
a = time.clock()
#bike_share_july = pd.read_csv('2013-07 - Citi Bike trip data.csv')
bike_share = pd.read_csv('2014-02 - Citi Bike trip data.csv')
#bike_share = genfromtxt('2014-02 - Citi Bike trip data.csv', delimiter=',',dtype=None)
b = time.clock()
print b-a
print bike_share.index
